!function () {
    function e() {
        if (void 0 != window.pageYOffset) return {x: pageXOffset, y: t(pageYOffset)};
    ...
    function l() {
        C.postMessage(["event", {type: "scroll", positions: e()}], "*")
    }
    ...
    function m(e) {
        var t = document.querySelector(e.targetPath),
            n = new MouseEvent(e.type, {bubbles: !0, cancelable: !0, view: window});
        t.dispatchEvent(n)
    }

    function y(e) {
        var t = document.querySelector(e.targetPath), n = new KeyboardEvent(e.type, e.options);
        t.dispatchEvent(n)
    }

    var w, g, E, b, N, T = 300, H = 500, Y = [], L = !1, X = 300, k = ["click", "keydown", "keypress", "keyup"],
